...
lr_result = biglm.big.matrix (DepDelay ~ Year + Month + DayofMonth + DayOfWeek + Distance + TaxiIn + TaxiOut + TEMP.x +
                                ...
                                Hail.y + Thunder.y + Tornado.y + season, fc=c('UniqueCarrier', 'Origin', 'Dest', 
                                                                              'Fog.x', 'Rain.x', 'Snow.x', 'Hail.x', 
                                                                              'Thunder.x', 'Tornado.x', 'Fog.y', 
                                                                              'Rain.y', 'Snow.y', 'Hail.y', 'Thunder.y',
                                                                              'aTornado.y', 'season'), data = dat )
```
